...
## data quality rules- Expectation rules
_orderrules = {
...
## data quality expectaion warn rules
@dlt.expect_all(_orderrules)
def order_bronze():
...
## data quality expectaion warn rules
@dlt.expect_all(_custrules)
def cust_bronze_vw():
    df = spark.readStream.table("devenv.bronze.customer_raw")
    return df
